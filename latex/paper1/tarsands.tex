...
\author{
  Prof. Alexander H. Slocum (\underline{{\tt slocum@mit.edu}})\\
  Massachusetts Institute of Technology
  \and
  David James Taylor (\underline{{\tt dtaylor@mit.edu}})\\
  Massachusetts Institute of Technology
 \and
 Kevin Patrick Simon (\underline{{\tt kevinpsi@mit.edu}}) \\
Massachusetts Institute of Technology
\and
Santiago Paiva (\underline{{\tt santiago.paiva@mail.mcgill.ca}})\\
McGill University
}
