...
\title{ {\bf A Symbiotic System Model for the Development of Canadian Oil Sands  } \\ \vspace{11pt}}

\author{Taylor D. J.$^{1}$, Slocum H. A.$^{1}$, Paiva S.$^{2}$, Simon K.$^{1}$, Bartlett M.$^{3}$}
