...
%
%     Oil Sands Paper 
%	Version Matching Word Document V16
%     Typed by Santiago 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\author{
  \small{Alexander H. Slocum\footnote{Professor, corresponding author, {\tt slocum@mit.edu}, +001.617.253.0012, MIT Room 3-344, 77 Massachusetts Avenue, Cambridge, MA 02139, USA} (\underline{{\tt slocum@mit.edu}})}\\
